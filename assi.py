...
#side bar contents
with st.sidebar:
    st.title('Pdf Transcription Chat-Bot Web-App')
    st.markdown("""
    ## About
    This Web-App Using:
    ...
    - [Github](https://github.com/Raj-Verma-1998) 
                
    """)
    add_vertical_space(5)
    st.write("HEy Its Me bIg-bUg")
    
    
load_dotenv()
    
def main():
    st.header("Pdf Transcription Chat-Bot Web-App 💬")
